...
async function entrar() {
  ...
  document.getElementById("botaoEntrar").style.color = "#68519d"
  document.getElementById("botaoSair").style.color = "#ffff"
  document.getElementById("welcome").style.color ="#ffff"
  document.getElementById("botaoCadastro").style.color ="#68519d"

  await imprimeTarefas(nomeLogin);
}

function botaoSair() {
  document.getElementById("botaoSair").style.color ="#68519d"
  document.getElementById("botaoEntrar").style.color ="#ffff"
  document.getElementById("welcome").style.color ="#68519d"
  document.getElementById("botaoCadastro").style.color ="#ffff"
